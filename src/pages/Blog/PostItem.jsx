...
function PostItem({ post }) {
  ...
  return (
    <div onClick={handleClick}>
      <div className="xl:justify-betwee flex w-full cursor-pointer flex-col gap-4 rounded-lg border border-gray-200 bg-gray-50 p-6  shadow-lg transition-[transform,opacity] duration-300 hover:scale-[101.5%] hover:opacity-95 xl:flex-row xl:items-center">
